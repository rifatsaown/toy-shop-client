        ...
        <div className="w-100 mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl xl:px-32">
          <div className="grid items-center lg:grid-cols-2">
            <div className="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
              <div className="block rounded-lg px-6 py-12 bg-[hsla(0,0%,5%,0.55)] shadow-black/20 md:px-12 lg:-mr-14 backdrop-blur-[60px]">
            ...
            <div className="md:mb-12 lg:mb-0 w-3/5 mx-auto sm:w-full md:w-full lg:w-full ">
              <img
                src={heroImg}
